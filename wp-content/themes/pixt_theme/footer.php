...
<script type="text/javascript">
  jQuery(document).ready(function() {
    var content = jQuery('#mobile-header .toggle').html();
    jQuery('#menu-item-253').append(content);
    jQuery('#menu-item-253 .icon-menu').show();

    jQuery('#menu-item-253 .icon-menu').on('click', function() {
      jQuery('#mega_main_menu_ul').hide();
      jQuery('.nav_logo').toggleClass('mobile_menu_active').toggle();
      jQuery('.symbol_menu').show();
    });

    jQuery('.symbol_menu').on('click', function() {
